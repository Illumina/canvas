...
namespace Illumina.Common
{
    ...
    public class OrderedDictionary<TKey, TValue> : IOrderedDictionary<TKey, TValue>
    {
        ...
        public KeyValuePair<TKey, TValue> this[int index]
        {
            ...
            set
            {
                SetItem(index, value.Key, value.Value);
            }
        }
        ...
        public KeyValuePair<TKey, TValue> GetItem(int index)
        {
            ...
            return ((Collection<KeyValuePair<TKey, TValue>>)_keyedCollection)[index];
        }
        ...
        public void SetItem(int index, TValue value)
        {
            ...
            Collection<KeyValuePair<TKey, TValue>> collection = (Collection<KeyValuePair<TKey, TValue>>)_keyedCollection;
            var kvp = new KeyValuePair<TKey, TValue>(collection[index].Key, value);
            collection[index] = kvp;
        }

        /// <summary>
        /// Sets the value and key at the index specified.
        /// </summary>
        /// <param name="index">The index of the key/value to set</param>
        /// <param name="value">The key to set</param>
        /// <param name="value">The value to set</param>
        /// <exception cref="ArgumentOutOfRangeException">
        /// Thrown when the index specified does not refer to a KeyValuePair in this object
        /// </exception>
        public void SetItem(int index, TKey key, TValue value)
        {
            if (index < 0 || index >= _keyedCollection.Count)
            {
                throw new ArgumentException(string.Format("The index is outside the bounds of the dictionary: {0}", index));
            ...
            Collection<KeyValuePair<TKey, TValue>> collection = (Collection<KeyValuePair<TKey, TValue>>)_keyedCollection;
            if (ContainsKey(key) && !_keyedCollection.Comparer.Equals(collection[index].Key, key))
                throw new ArgumentException("An element with the same key already exists in the OrderedDictionary");
            var kvp = new KeyValuePair<TKey, TValue>(collection[index].Key, value);
            collection[index] = kvp;
        }
        ...
        int IList<KeyValuePair<TKey, TValue>>.IndexOf(KeyValuePair<TKey, TValue> kvp)
        {
            return _keyedCollection.IndexOf(kvp);
        }

        void IList<KeyValuePair<TKey, TValue>>.Insert(int index, KeyValuePair<TKey, TValue> kvp)
        {
    ...
    {
        public static OrderedDictionary<TKey, TValue> ToOrderedDictionary<TSource, TKey, TValue>(this IEnumerable<TSource> sources, Func<TSource, TKey> keySelector, Func<TSource, TValue> valueSelector)
        {
            OrderedDictionary<TKey, TValue> result = new OrderedDictionary<TKey, TValue>();
            foreach (TSource source in sources)
            {
                result.Add(keySelector(source), valueSelector(source));
            }
            return result;
        }
    }
