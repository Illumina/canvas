...
namespace Isas.Shared
{
    ...
    public class EnrichmentStatistics : WorkflowStatistics
    {
        ...
        {
            get { return "EnrichmentStatistics.xml"; }
        }
        ...
        {
            [XmlIgnore] [ProtoMember(1)] public long[] AlignedBaseCount;
            [XmlIgnore] [ProtoMember(2)] public int[] BaseCount;
            [ProtoMember(3)] public string Chromosome;
            [ProtoMember(4)] public long[] ClustersPF;
            [ProtoMember(5)] public long[] ClustersRaw;
            [ProtoMember(6)] public float Coverage;
            [XmlIgnore] [ProtoMember(7)] public int[] CoverageByPosition;
            [ProtoMember(8)] public int EndPosition;
            [XmlIgnore] [ProtoMember(9)] public long[] ErrorCount;
            [ProtoMember(10)] public float[] ErrorRate;
            [ProtoMember(11)] public int Genome;
            [ProtoMember(12)] public string Manifest;
            [XmlIgnore] [ProtoMember(13)] public int[] NoCallCount;
            [ProtoMember(14)] public float[] NoCallRate;

            [XmlIgnore] [ProtoMember(15)] public Dictionary<string, int> ReadsBySample;
                // Aligned reads by sample - this counts R1 and R2 separately, so this is up to 2x the sample cluster count

            [ProtoMember(16)] public string RegionName;
            ...
            [ProtoMember(17)] public int StartPosition;
            [NonSerialized] public VariantsForSequence VariantInfo;
            // ReSharper restore InconsistentNaming
