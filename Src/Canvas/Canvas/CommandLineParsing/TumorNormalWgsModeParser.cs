...
namespace Canvas.CommandLineParsing
{
    ...
    internal class TumorNormalOptionsParser : Option<TumorNormalOptions>
    {
        ...
        private static readonly FileOption SomaticVcf = FileOption.Create(".vcf file of somatic small variants found in the tumor sample. Used as a fallback for estimating purity.", "somatic-vcf");
