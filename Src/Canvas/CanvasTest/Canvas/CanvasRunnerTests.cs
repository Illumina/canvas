...
namespace CanvasTest.Canvas
{
    public sealed class CanvasRunnerTests
    {
        ...
        public void GetExecutablePath_test()
        {
            ...
            int countsPerBin = 0;
            var canvasRunner = new CanvasRunner(logger, workManager, checkpointRunner, runtimeExecutable, isSomatic, coverageMode, countsPerBin);
            string canvasFolder = CanvasRunner.DefaultCanvasFolder;
