    ...
    class CanvasPartition
    {
        ...
        static int Main(string[] args)
        {
            ...
            OptionSet p = new OptionSet()
            {
                ...
                { "i|vaffile=", "variant frequencyfiles - usually generated by CanvasSNV", v => vafFiles.Add(v) },
            ...
            var segmentationEngine = inFiles.Zip(vafFiles, (inFile, vafFile) => new Segmentation(inFile, vafFile, bedPath, maxInterBinDistInSegment)).ToList();          
            ...
            switch (partitionMethod)
            {
                ...
                case Segmentation.SegmentationMethod.HMM:
                    ...
                    var hiddenMarkovModelsRunner = new HiddenMarkovModelsRunner(commonCNVsbedPath, inFiles.Count);
